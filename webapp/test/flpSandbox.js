		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#mentoriafiorikamodel1vsmzkauimodel1vsm-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mentoriafiorikamodel1vsmzkauimodel1vsm-display": {
								"semanticObject": "mentoriafiorikamodel1vsmzkauimodel1vsm",
								"action": "display",
								"description": "Prática Model 1",
								"title": "App Title",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mentoria.fiori.ka.model1.vsm.zkauimodel1vsm",
									"url": sap.ui.require.toUrl("mentoria/fiori/ka/model1/vsm/zkauimodel1vsm")
								}
							}
						}
					}
